...
public class GlobalLibraryWithLegacyJCasCCompatibilityTest extends RoundTripAbstractTest {
    ...
    protected void assertConfiguredAsExpected(RestartableJenkinsRule restartableJenkinsRule, String s) {
        ...
        assertThat(
                gitSCM.getBranches(),
                containsInAnyOrder(
                        allOf(instanceOf(BranchSpec.class), hasProperty("name", equalTo("master"))),
                        allOf(instanceOf(BranchSpec.class), hasProperty("name", equalTo("myprodbranch")))));
        ...
        assertThat(
                ...
                containsInAnyOrder(
                        ...
                        allOf(instanceOf(CheckoutOption.class), hasProperty("timeout", equalTo(1))),
                        ...
                        allOf(instanceOf(LocalBranch.class), hasProperty("localBranch", equalTo("local_branch"))),
                        // Clean after checkout
                        allOf(instanceOf(CleanCheckout.class)),
                        // Clean before checkout
                        allOf(instanceOf(CleanBeforeCheckout.class)),
                        // Create a tag for every build
                        allOf(instanceOf(PerBuildTag.class)),
                        // Don't trigger a build on commit notifications
                        allOf(instanceOf(IgnoreNotifyCommit.class)),
                        // Force polling using workspace
                        allOf(instanceOf(DisableRemotePoll.class)),
                        // Git LFS pull after checkout
                        allOf(instanceOf(GitLFSPull.class)),
                        // Prune stale remote-tracking branches
                        allOf(instanceOf(PruneStaleBranch.class)),
                        // Prune stale tags
                        allOf(instanceOf(PruneStaleTag.class)),
                        // Use commit author in changelog
                        allOf(instanceOf(AuthorInChangelog.class)),
                        // Wipe out repository & force clone
                        allOf(instanceOf(WipeWorkspace.class)),
                        // Custom SCM name
                        allOf(instanceOf(ScmName.class), hasProperty("name", equalTo("my_scm"))),
                        ...
                        allOf(instanceOf(UserExclusion.class), hasProperty("excludedUsers", equalTo("me"))),
                        ...
                        allOf(
                                ...
                                hasProperty(
                                        ...
                                        hasProperty(
                                                "fastForwardMode",
                                                equalTo(MergeCommand.GitPluginFastForwardMode.FF_ONLY))),
                                ...
                                hasProperty(
                                        "options",
                                        hasProperty("mergeStrategy", equalTo(MergeCommand.Strategy.OCTOPUS)))),
