...
public class GitSCMBuilderTest {
    ...
    private GitSCMBuilder<?> instance =
            new GitSCMBuilder<>(new SCMHead("master"), null, "http://git.test/repo.git", null);
    ...
    public void withRevision() throws Exception {
        ...
        assertThat(
                scm.getExtensions().get(BuildChooserSetting.class).getBuildChooser(),
        ...
        assertThat(
                scm.getExtensions()
                        ...
                        .getBuildChooser()
                        .getCandidateRevisions(false, null, (GitClient) null, null, null, null)
                        .iterator()
                        .next()
                        .getSha1String(),
                is("3f0b897057d8b43d3b9ff55e3fdefbb021493470"));
    }
    ...
    public void withExtension() throws Exception {
        ...
        assertThat(
                scm.getExtensions(),
                containsInAnyOrder(instanceOf(AuthorInChangelog.class), instanceOf(GitSCMSourceDefaults.class)));
    ...
    public void withExtensions() throws Exception {
        ...
        assertThat(
                instance.extensions(),
                containsInAnyOrder(instanceOf(AuthorInChangelog.class), instanceOf(CleanCheckout.class)));
        scm = instance.build();
        assertThat(scm.getBrowser(), is(nullValue()));
        assertThat(
                scm.getUserRemoteConfigs(),
    ...
    public void withRefSpecAndCloneOption() throws Exception {
        ...
        assertThat(
                ...
                contains(allOf(
                        ...
                        hasProperty("credentialsId", is(nullValue())))));
        assertThat(scm.getGitTool(), is(nullValue()));
        assertThat(scm.getExtensions(), contains(instanceOf(CloneOption.class)));
    }
    ...
    public void withRefSpec() throws Exception {
        ...
        assertThat(
                ...
                containsInAnyOrder(allOf(
                        ...
                        hasProperty(
                                "refspec",
                                is("+refs/heads/master:refs/remotes/origin/master "
    ...
    public void withAdditionalRemote() throws Exception {
        instance.withAdditionalRemote(
                "upstream", "http://git.test/upstream.git", "+refs/heads/master:refs/remotes/@{remote}/master");
        ...
        assertThat(
                instance.additionalRemoteRefSpecs("upstream"),
                contains("+refs/heads/master:refs/remotes/@{remote}/master"));
        GitSCM scm = instance.build();
        assertThat(scm.getBrowser(), is(nullValue()));
        assertThat(
                scm.getUserRemoteConfigs(),
        ...
        assertThat(instance.additionalRemoteRefSpecs("production"), contains("+refs/heads/*:refs/remotes/@{remote}/*"));
        scm = instance.build();
        assertThat(scm.getBrowser(), is(nullValue()));
        assertThat(
                scm.getUserRemoteConfigs(),
