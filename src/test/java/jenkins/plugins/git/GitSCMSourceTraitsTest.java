...
public class GitSCMSourceTraitsTest {
    ...
    public void pimpped_out() throws Exception {
        ...
        assertThat(
                ...
                containsInAnyOrder(
                        ...
                        Matchers.allOf(
                                ...
                                hasProperty("extension", hasProperty("timeout", is(5)))),
                        Matchers.allOf(
                        ...
                        Matchers.allOf(
                                ...
                                hasProperty("extension", hasProperty("localBranch", is("**")))),
                        Matchers.allOf(
                                instanceOf(CleanBeforeCheckoutTrait.class),
                                hasProperty("extension", hasProperty("deleteUntrackedNestedRepositories", is(true)))),
                        Matchers.allOf(
                                instanceOf(CleanAfterCheckoutTrait.class),
                                hasProperty("extension", hasProperty("deleteUntrackedNestedRepositories", is(true)))),
                        Matchers.allOf(
                        ...
                        Matchers.allOf(
                                ...
                                hasProperty(
                                        "browser",
                                        allOf(instanceOf(BitbucketWeb.class), hasProperty("repoUrl", is("foo"))))),
                        Matchers.allOf(
                                instanceOf(SparseCheckoutPathsTrait.class),
                                hasProperty("extension", allOf(hasProperty("sparseCheckoutPaths", hasSize(2)))))));
        // Legacy API
        ...
        assertThat(
                ...
                containsInAnyOrder(
                        Matchers.allOf(instanceOf(CheckoutOption.class), hasProperty("timeout", is(5))),
                        Matchers.allOf(
                        ...
                        Matchers.allOf(
                                ...
                                hasProperty("parentCredentials", is(true)),
                                hasProperty("timeout", is(4))),
                        Matchers.allOf(instanceOf(LocalBranch.class), hasProperty("localBranch", is("**"))),
        ...
        assertThat(instance.getBrowser(), allOf(instanceOf(BitbucketWeb.class), hasProperty("repoUrl", is("foo"))));
    ...
    public void given__legacyCode__when__constructor__then__traitsContainLegacyDefaults2() throws Exception {
        ...
        assertThat(
                instance.getTraits(),
                containsInAnyOrder(
                        instanceOf(BranchDiscoveryTrait.class), instanceOf(IgnoreOnPushNotificationTrait.class)));
        assertThat(instance.isIgnoreOnPushNotifications(), is(true));
    }
    ...
    public void given__legacyCode__when__constructor__then__traitsContainLegacyDefaults5() throws Exception {
        ...
        assertThat(
                ...
                contains(
                        instanceOf(BranchDiscoveryTrait.class),
                        allOf(instanceOf(RemoteNameSCMSourceTrait.class), hasProperty("remoteName", is("upstream")))));
    ...
    public void given__legacyCode__when__constructor__then__traitsContainLegacyDefaults6() throws Exception {
        GitSCMSource instance = new GitSCMSource(
                "id", "git://git.test/example.git", null, null, "refs/pulls/*:refs/upstream/*", "*", "", false);
        assertThat(
                instance.getTraits(),
                contains(
                        instanceOf(BranchDiscoveryTrait.class),
                        allOf(
                                ...
                                hasProperty(
                                        "templates",
                                        contains(hasProperty("value", is("refs/pulls/*:refs/upstream/*")))))));
