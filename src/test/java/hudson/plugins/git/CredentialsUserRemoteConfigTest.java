...
public class CredentialsUserRemoteConfigTest {
    ...
    private String randomPipelineExtensions() {
        ...
        String [] extensions = {
            ...
            "cloneOption(depth: 3, honorRefspec: true, noTags: true, reference: '/cache/git.git', shallow: true, timeout: 13)",
            "cloneOption(depth: 3, honorRefspec: true, noTags: true, reference: '/cache/git.git', shallow: true)",
            "cloneOption(depth: 3, honorRefspec: true, noTags: true, reference: '/cache/git.git')",
            "cloneOption(depth: 3, honorRefspec: true, noTags: true)",
            "cloneOption(depth: 3, honorRefspec: true)",
            "cloneOption(depth: 3)",
            "cloneOption(honorRefspec: true, noTags: true, reference: '/cache/git.git', shallow: true, timeout: 13)",
            "cloneOption(honorRefspec: true, noTags: true, reference: '/cache/git.git', shallow: true)",
            "cloneOption(honorRefspec: true, noTags: true, reference: '/cache/git.git')",
