...
public class PreBuildMergeTest extends GitSCMExtensionTest {
    ...
    public void testFailedMerge() throws Exception {
        ...
        repo.commit(
                MASTER_FILE,
                "new content on integration branch",
                repo.johnDoe,
                repo.johnDoe,
                "Commit which should fail!");
        ...
        String conflictSha1 = repo.commit(
                MASTER_FILE,
                "new content - expect a merge conflict!",
                repo.johnDoe,
                repo.johnDoe,
                "Commit which should fail!");
    ...
    protected GitSCMExtension getExtension() {
        return new PreBuildMerge(
                new UserMergeOptions("origin", "integration", "default", MergeCommand.GitPluginFastForwardMode.FF));
    }
}
