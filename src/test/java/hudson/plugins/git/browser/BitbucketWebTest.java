...
public class BitbucketWebTest {
    ...
    public void testGetDiffLinkPath() throws Exception {
        ...
        assertEquals(
                BITBUCKET_URL + "/commits/396fc230a3db05c427737aa5c2eb7856ba72b05d#chg-" + path1Str,
                bitbucketWeb.getDiffLink(path1).toString());

        final String path2Str = "src/test/java/hudson/plugins/git/browser/GithubWebTest.java";
        final Path path2 = pathMap.get(path2Str);
        assertEquals(
                BITBUCKET_URL + "/commits/396fc230a3db05c427737aa5c2eb7856ba72b05d#chg-" + path2Str,
                bitbucketWeb.getDiffLink(path2).toString());
    ...
    public void testGetFileLinkPath() throws Exception {
        ...
        assertEquals(
                BITBUCKET_URL + "/history/src/main/java/hudson/plugins/git/browser/GithubWeb.java",
    ...
    private GitChangeSet createChangeSet(String rawchangelogpath) throws Exception {
        ...
        final List<GitChangeSet> changeSetList =
                logParser.parse(BitbucketWebTest.class.getResourceAsStream(rawchangelogpath));
