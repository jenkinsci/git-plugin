...
public class GitoriousWebTest {
    ...
    public void testGetDiffLinkPath() throws Exception {
        ...
        assertEquals(
                GITORIOUS_URL
                        + "/commit/396fc230a3db05c427737aa5c2eb7856ba72b05d/diffs?diffmode=sidebyside&fragment=1#src/main/java/hudson/plugins/git/browser/GithubWeb.java",
                gitoriousWeb.getDiffLink(modified1).toString());
        ...
        assertEquals(
                GITORIOUS_URL
                        + "/commit/396fc230a3db05c427737aa5c2eb7856ba72b05d/diffs?diffmode=sidebyside&fragment=1#src/test/resources/hudson/plugins/git/browser/rawchangelog-with-deleted-file",
                gitoriousWeb.getDiffLink(added).toString());
    }
    ...
    public void testGetFileLinkPath() throws Exception {
        ...
        assertEquals(
                GITORIOUS_URL
                        + "/blobs/396fc230a3db05c427737aa5c2eb7856ba72b05d/src/main/java/hudson/plugins/git/browser/GithubWeb.java",
    ...
    public void testGetFileLinkPathForDeletedFile() throws Exception {
        ...
        assertEquals(
                GITORIOUS_URL
                        + "/commit/fc029da233f161c65eb06d0f1ed4f36ae81d1f4f/diffs?diffmode=sidebyside&fragment=1#bar",
                String.valueOf(fileLink));
    }
    ...
    private GitChangeSet createChangeSet(String rawchangelogpath) throws Exception {
        ...
        final List<GitChangeSet> changeSetList =
                logParser.parse(GitoriousWebTest.class.getResourceAsStream(rawchangelogpath));
