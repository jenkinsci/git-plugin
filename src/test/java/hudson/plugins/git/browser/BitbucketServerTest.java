...
public class BitbucketServerTest {
    ...
    public void testGetDiffLinkPath() throws Exception {
        ...
        assertEquals(
                BITBUCKET_URL + "/commits/396fc230a3db05c427737aa5c2eb7856ba72b05d#" + path1Str,
                bitbucketServer.getDiffLink(path1).toString());

        final String path2Str = "src/test/java/hudson/plugins/git/browser/GithubWebTest.java";
        final Path path2 = pathMap.get(path2Str);
        assertEquals(
                BITBUCKET_URL + "/commits/396fc230a3db05c427737aa5c2eb7856ba72b05d#" + path2Str,
                bitbucketServer.getDiffLink(path2).toString());
    ...
    public void testGetFileLinkPath() throws Exception {
        ...
        assertEquals(
                BITBUCKET_URL + "/browse/src/main/java/hudson/plugins/git/browser/GithubWeb.java",
    ...
    private GitChangeSet createChangeSet(String rawchangelogpath) throws Exception {
        ...
        final List<GitChangeSet> changeSetList =
                logParser.parse(BitbucketServerTest.class.getResourceAsStream(rawchangelogpath));
