...
public class GogsGitTest {
    ...
    public void testGetDiffLinkPath() throws Exception {
        ...
        assertEquals(
                GOGS_URL + "/commit/396fc230a3db05c427737aa5c2eb7856ba72b05d#diff-1",
                GogsGit.getDiffLink(path1).toString());
        final Path path2 = pathMap.get("src/test/java/hudson/plugins/git/browser/GithubWebTest.java");
        assertEquals(
                GOGS_URL + "/commit/396fc230a3db05c427737aa5c2eb7856ba72b05d#diff-2",
                GogsGit.getDiffLink(path2).toString());
    ...
    public void testGetFileLinkPath() throws Exception {
        ...
        assertEquals(
                GOGS_URL
                        + "/src/396fc230a3db05c427737aa5c2eb7856ba72b05d/src/main/java/hudson/plugins/git/browser/GithubWeb.java",
    ...
    private GitChangeSet createChangeSet(String rawchangelogpath) throws Exception {
        ...
        final List<GitChangeSet> changeSetList =
                logParser.parse(GogsGitTest.class.getResourceAsStream(rawchangelogpath));
