...
public class GitWebTest {
    ...
    public void testGetDiffLinkPath() throws Exception {
        ...
        assertEquals(
                GITWEB_URL
                        + "&a=blobdiff&f=src/main/java/hudson/plugins/git/browser/GithubWeb.java&fp=src/main/java/hudson/plugins/git/browser/GithubWeb.java&h=3f28ad75f5ecd5e0ea9659362e2eef18951bd451&hp=2e0756cd853dccac638486d6aab0e74bc2ef4041&hb=396fc230a3db05c427737aa5c2eb7856ba72b05d&hpb=f28f125f4cc3e5f6a32daee6a26f36f7b788b8ff",
                gitwebWeb.getDiffLink(modified1).toString());
    }
    ...
    public void testGetFileLinkPath() throws Exception {
        ...
        assertEquals(
                GITWEB_URL
                        + "&a=blob&f=src/main/java/hudson/plugins/git/browser/GithubWeb.java&h=2e0756cd853dccac638486d6aab0e74bc2ef4041&hb=396fc230a3db05c427737aa5c2eb7856ba72b05d",
    ...
    public void testGetFileLinkPathForDeletedFile() throws Exception {
        ...
        assertEquals(
                GITWEB_URL
                        + "&a=blob&f=bar&h=257cc5642cb1a054f08cc83f2d943e56fd3ebe99&hb=fc029da233f161c65eb06d0f1ed4f36ae81d1f4f",
                String.valueOf(fileLink));
    }
    ...
    private GitChangeSet createChangeSet(String rawchangelogpath) throws Exception {
        ...
        final List<GitChangeSet> changeSetList =
                logParser.parse(GitWebTest.class.getResourceAsStream(rawchangelogpath));
