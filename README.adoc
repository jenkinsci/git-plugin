...
Disable using recommendation for git implementation::

  If checked, the plugin will disable a feature which recommends a git implementation on the basis of
  the size of a repository. This switch may be used in case of a bug in the performance improvement feature.
