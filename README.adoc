...
The link:https://youtu.be/ai1kf4ihZUo[90 second video clip] linked below introduces the Pipeline Syntax helper and shows how it is used to generate statements for the Jenkins Pipeline.
