...
For it you can use link:https://www.jenkins.io/doc/pipeline/steps/workflow-multibranch/#resolvescm-resolves-an-scm-from-an-scm-source-and-a-list-of-candidate-target-branch-names[resolveScm].

You can pass `cloneOption` trait with shallow flag for speed-up retrieve target branch. Just add in `traits` param these code:
[source,groovy]
----
