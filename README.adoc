...
The link:https://youtu.be/ai1kf4ihZUo[90 second video clip] linked below introduces the Pipeline Syntax snippet generator and shows how it is used to generate steps for the Jenkins Pipeline.
...
image:https://img.youtube.com/vi/B_2FXWI6CWg/maxresdefault.jpg[link=https://youtu.be/B_2FXWI6CWg]
...
The property should be set on the controller and on all agents to have effect (see https://issues.jenkins-ci.org/browse/JENKINS-22547[JENKINS-22547]).
