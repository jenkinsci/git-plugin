...
Release notes are recorded in https://github.com/jenkinsci/git-plugin/releases[GitHub] beginning with git plugin 3.10.1.
Prior release notes are recorded in the link:CHANGELOG.adoc#[change log] in the git plugin repository.
