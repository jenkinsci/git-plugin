...
[[using-Java-System-Property-push-notification-from-repository]]
...
[#using-a-groovy-script-push-notification-from-repository]
 Using a Groovy Script::

The property can be set using a Groovy script placed in the `init.groovy.d` directory. This method is useful for environments where you manage Jenkins settings through scripts:
