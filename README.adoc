...
Checkout from the git client plugin source repository using https protocol, ssh private credentials, and a non-default branch. 
...
checkout([$class: 'GitSCM',
          branches: [[name: 'master']],
          userRemoteConfigs: [[credentialsId: 'e1476d45-b77d-4af6-a80f-e2fe95eca822', url: 'https://github.com/jenkinsci/git-plugin.git']]])
---
...
checkout([$class: 'GitSCM',
          ...
          userRemoteConfigs: [[credentialsId: 'e1476d45-b77d-4af6-a80f-e2fe95eca822', url: 'https://github.com/jenkinsci/git-client-plugin.git']]])
---

==== Checkout with git large file support enabled

Checkout from the git client plugin source repository using https no credentials, a non-default branch, and git large file support extension link:https://git-lfs.github.com 
...
See also the https://youtu.be/jBGFjFc6Jf8?t=6434 for performance tips that would be good for examples
