...
(https://issues.jenkins.io/browse/JENKINS-51638[JENKINS-51638])
...
repo (https://issues.jenkins.io/browse/JENKINS-50394[JENKINS-50394])
...
(https://issues.jenkins.io/browse/JENKINS-21248[JENKINS-21248])
* Add option to search for users by e-mail address
(https://issues.jenkins.io/browse/JENKINS-9016[JENKINS-9016])
* Add parallel update for submodules
(https://issues.jenkins.io/browse/JENKINS-44720[JENKINS-44720])
* Stop bloating build.xml files with BuildData
(https://issues.jenkins.io/browse/JENKINS-19022[JENKINS-19022])
* Fix notifyCommit for branch names that contain '/' characters
(https://issues.jenkins.io/browse/JENKINS-29603[JENKINS-29603],
https://issues.jenkins.io/browse/JENKINS-32174[JENKINS-32174])
* Fix empty "depth" parameter handling for shallow cloning
(https://issues.jenkins.io/browse/JENKINS-53050[JENKINS-53050])
* Ignore exceptions when generating commit message as informational
message in build log
(https://issues.jenkins.io/browse/JENKINS-53725[JENKINS-53725])
* Fix snippet generator gitlab version class cast exception
(https://issues.jenkins.io/browse/JENKINS-46650[JENKINS-46650])
* Fix git tool references on agent
(https://issues.jenkins.io/browse/JENKINS-55827[JENKINS-55827])
...
(https://issues.jenkins.io/browse/JENKINS-50621[JENKINS-50621],
https://issues.jenkins.io/browse/JENKINS-50540[JENKINS-50540],
https://issues.jenkins.io/browse/JENKINS-50777[JENKINS-50777])
* Support SHA1 references in Pipeline shared libraries
(https://issues.jenkins.io/browse/JENKINS-48061[JENKINS-48061])
...
(https://issues.jenkins.io/browse/JENKINS-50683[JENKINS-50683] and
...
UserMergeOptions
(https://issues.jenkins.io/browse/JENKINS-34070[JENKINS-34070])
* Retain repository browser URL when saved from Pipeline job
definition page
(https://issues.jenkins.io/browse/JENKINS-36451[JENKINS-36451])
...
(https://issues.jenkins.io/browse/JENKINS-45447[JENKINS-45447])
...
(https://issues.jenkins.io/browse/JENKINS-48064[JENKINS-48064])
* Allow retry by throwing IOException if submodule update fails
(https://issues.jenkins.io/browse/JENKINS-32481[JENKINS-32481])
* Don't pass empty username to User.get()
(https://issues.jenkins.io/browse/JENKINS-48589[JENKINS-48589])

== Version 3.6.4 (November 5, 2017)

* Add support for tagged pipeline shared libraries lost in 3.6.3
(https://issues.jenkins.io/browse/JENKINS-47824[JENKINS-47824])

== Version 3.6.3 (October 26, 2017)

* Fix ssh based branch indexing failure with default credentials
(https://issues.jenkins.io/browse/JENKINS-47629[JENKINS-47629],
https://issues.jenkins.io/browse/JENKINS-47659[JENKINS-47659],
https://issues.jenkins.io/browse/JENKINS-47680[JENKINS-47680])

== Version 3.6.2 (October 23, 2017)

* Fix visibility of enum required to implement new API for
https://issues.jenkins.io/browse/JENKINS-47526[JENKINS-47526]

== Version 3.6.1 (October 23, 2017)

* A merge conflict in PreBuildMerge will corrupt BuildData history in
previous builds
(https://issues.jenkins.io/browse/JENKINS-44037[JENKINS-44037])
...
GitSCMSource
(https://issues.jenkins.io/browse/JENKINS-47526[JENKINS-47526])
* Change the UI for Advanced Clone Behaviours to avoid confusing
"negative" fetch tags label
(https://issues.jenkins.io/browse/JENKINS-45822[JENKINS-45822])

== Version 3.6.0 (October 2, 2017)

* Allow traits to support tag discovery
(https://issues.jenkins.io/browse/JENKINS-46207[JENKINS-46207])
* Don't exceed response header length
(https://issues.jenkins.io/browse/JENKINS-46929[JENKINS-46929])
* Don't fail build if diagnostic print of commit message fails
(https://issues.jenkins.io/browse/JENKINS-45729[JENKINS-45729])
...
(https://issues.jenkins.io/browse/JENKINS-42817[JENKINS-42817])
* Show folder scoped credentials in modern SCM
(https://issues.jenkins.io/browse/JENKINS-44271[JENKINS-44271])
...
(https://issues.jenkins.io/browse/JENKINS-44751[JENKINS-44751])
...
(https://issues.jenkins.io/browse/JENKINS-45771[JENKINS-45771])

== Version 3.4.1 (July 18, 2017)

* Fix credentials field being incorrectly marked as transient
(https://issues.jenkins.io/browse/JENKINS-45598[JENKINS-45598])
...
(https://issues.jenkins.io/browse/JENKINS-43507[JENKINS-43507]).
...
(https://issues.jenkins.io/browse/JENKINS-38241[JENKINS-38241],
https://issues.jenkins.io/browse/JENKINS-38827[JENKINS-38827])
* Allow scm steps to return revision
(https://issues.jenkins.io/browse/JENKINS-26100[JENKINS-26100],
https://issues.jenkins.io/browse/JENKINS-38827[JENKINS-38827)])
* Don't require crumb for POST to /git/notifyCommit even when CSRF is
enabled
(https://issues.jenkins.io/browse/JENKINS-34350[JENKINS-34350])
* Fix credentials tracking null pointer exception in pipeline library
use (https://issues.jenkins.io/browse/JENKINS-44640[JENKINS-44640])
* Fix credentials tracking null pointer exception in git parameters
use (https://issues.jenkins.io/browse/JENKINS-44087[JENKINS-44087])

== Version 3.3.0 (April 21, 2017)

* Track credentials use so that credentials show the jobs which use
them (https://issues.jenkins.io/browse/JENKINS-38827[JENKINS-38827])
* Add a "Branches" list view column
(https://issues.jenkins.io/browse/JENKINS-37331[JENKINS-37331])
* Add some Italian localization
* Fix null pointer exception when pipeline definition includes a
branch with no repository
(https://issues.jenkins.io/browse/JENKINS-43630[JENKINS-43630])

== Version 3.2.0 (March 28, 2017)

* Add reporting API for default remote branch (https://issues.jenkins.io/browse/JENKINS-40834[JENKINS-40834])
* Remove extra git tag actions from build results sidebar
(https://issues.jenkins.io/browse/JENKINS-35475[JENKINS-35475])

== Version 3.1.0 (March 4, 2017)

* Add command line git https://git-lfs.github.com/[large file support (LFS)]
(https://issues.jenkins.io/browse/JENKINS-30318[JENKINS-30318],
https://issues.jenkins.io/browse/JENKINS-35687[JENKINS-35687],
https://issues.jenkins.io/browse/JENKINS-38708[JENKINS-38708],
https://issues.jenkins.io/browse/JENKINS-40174[JENKINS-40174])
* Allow custom remote and refspec for GitSCMSource (https://issues.jenkins.io/browse/JENKINS-40908[JENKINS-40908])
* Add help for GitSCMSource (https://issues.jenkins.io/browse/JENKINS-42204[JENKINS-42204])
* Add help for multiple refspecs (https://issues.jenkins.io/browse/JENKINS-42050[JENKINS-42050])
* Log a warning if buildsByBranchName is too large (https://issues.jenkins.io/browse/JENKINS-19022[JENKINS-19022])
* Avoid incorrect triggers when processing events (https://issues.jenkins.io/browse/JENKINS-42236[JENKINS-42236])
...
(https://issues.jenkins.io/browse/JENKINS-41812[JENKINS-41812])
...
instantiation
(https://issues.jenkins.io/browse/JENKINS-39837[JENKINS-39837])
* Updated Japanese translations
* Upgrade to SCM API 2.0.x APIs
(https://issues.jenkins.io/browse/JENKINS-39355[JENKINS-39355])
...
(https://issues.jenkins.io/browse/JENKINS-40382[JENKINS-40382])
...
(https://issues.jenkins.io/browse/JENKINS-31155[JENKINS-31155])
* Avoid null pointer exception in prebuild use of build data
(https://issues.jenkins.io/browse/JENKINS-34369[JENKINS-34369])
* Allow git credentials references from global configuration screens
(https://issues.jenkins.io/browse/JENKINS-38048[JENKINS-38048])
...
repository (https://issues.jenkins.io/browse/JENKINS-20941[JENKINS-20941])
...
(https://issues.jenkins.io/browse/JENKINS-33983[JENKINS-33983],
https://issues.jenkins.io/browse/JENKINS-35565[JENKINS-35565],
https://issues.jenkins.io/browse/JENKINS-35567[JENKINS-35567],
https://issues.jenkins.io/browse/JENKINS-36958[JENKINS-36958],
https://issues.jenkins.io/browse/JENKINS-37297[JENKINS-37297])
* Remove deleted branches from multi-branch cache when using command
line git (https://issues.jenkins.io/browse/JENKINS-37727[JENKINS-37727])
* Create multi-branch cache parent directories if needed
(https://issues.jenkins.io/browse/JENKINS-37482[JENKINS-37482])
* Use credentials API 2.1 (https://issues.jenkins.io/browse/JENKINS-35525[JENKINS-35525])
...
* Fix gogs repository browser configuration (https://issues.jenkins.io/browse/JENKINS-37066[JENKINS-37066])
* Optionally "honor refspec on initial clone" rather than always
honoring refspec on initial clone (https://issues.jenkins.io/browse/JENKINS-36507[JENKINS-36507])
* Don't ignore the checkout timeout value (https://issues.jenkins.io/browse/JENKINS-22547[JENKINS-22547])

== Version 3.0.0-beta2 (July 6, 2016)

* Fix compatibility break introduced by git plugin 2.5.1 release
(https://issues.jenkins.io/browse/JENKINS-36419[JENKINS-36419])
...
* Honor refspec on initial fetch (https://issues.jenkins.io/browse/JENKINS-31393[JENKINS-31393]) (note, some users may
...
(https://issues.jenkins.io/browse/JENKINS-33956[JENKINS-33956])
...
built (https://issues.jenkins.io/browse/JENKINS-26268[JENKINS-26268])
...
(https://issues.jenkins.io/browse/JENKINS-35247[JENKINS-35247]); *note* that if you have the _Pipeline: SCM Step_ plugin
...
from controller
* Move pipeline GitStep from pipeline plugin to git plugin
(https://issues.jenkins.io/browse/JENKINS-35247[JENKINS-35247])
...
(https://issues.jenkins.io/browse/JENKINS-33695[JENKINS-33695] and https://issues.jenkins.io/browse/JENKINS-33564[JENKINS-33564])
* Restore BuildData.equals lost in git plugin 2.4.2 revert mistake
(https://issues.jenkins.io/browse/JENKINS-29326[JENKINS-29326])

== Version 2.4.3 (March 19, 2016)

* Optionally derive local branch name from remote branch name
(https://issues.jenkins.io/browse/JENKINS-33202[JENKINS-33202])
* Allow shallow clone depth to be specified (https://issues.jenkins.io/browse/JENKINS-24728[JENKINS-24728])
* Allow publishing from shallow clone if git version supports it
(https://issues.jenkins.io/browse/JENKINS-31108[JENKINS-31108])
* Allow GitHub browser guesser to work even if multiple refspecs
defined for same URL (https://issues.jenkins.io/browse/JENKINS-33409[JENKINS-33409])
* Clarify Team Foundation Server browser name (remove 2013 specific
string)
* Reduce memory use in difference calculation (https://issues.jenkins.io/browse/JENKINS-31326[JENKINS-31326])
* Resolve several findbugs warnings

== Version 2.4.2 (February 1, 2016)

* Show changelog even if prune stale branches is enabled
(https://issues.jenkins.io/browse/JENKINS-29482[JENKINS-29482])
* Set GIT_PREVIOUS_SUCCESSFUL_COMMIT even if prune stale branches is
enabled (https://issues.jenkins.io/browse/JENKINS-32218[JENKINS-32218])

== Version 2.4.1 (December 26, 2015)

* Allow clone to optionally not fetch tags (https://issues.jenkins.io/browse/JENKINS-14572[JENKINS-14572])
* Allow submodules to use a reference repo (https://issues.jenkins.io/browse/JENKINS-18666[JENKINS-18666])
* Use OR instead of AND when combining multiple refspecs
(https://issues.jenkins.io/browse/JENKINS-29796[JENKINS-29796])
* Remove dead branches from BuildData (https://issues.jenkins.io/browse/JENKINS-29482[JENKINS-29482])
* Fix Java 6 date parsing error (https://issues.jenkins.io/browse/JENKINS-29857[JENKINS-29857])
* Set changeset time correctly (https://issues.jenkins.io/browse/JENKINS-30073[JENKINS-30073])
* Include parent SHA1 in RhodeCode diff URL (https://issues.jenkins.io/browse/JENKINS-17117[JENKINS-17117])
* Don't set GIT_COMMIT to an empty value (https://issues.jenkins.io/browse/JENKINS-27180[JENKINS-27180])
* Fix AssemblaWeb diff link (https://issues.jenkins.io/browse/JENKINS-29731[JENKINS-29731])
* Attempt fix for multi-scm sporadic failures (https://issues.jenkins.io/browse/JENKINS-26587[JENKINS-26587])

== Version 2.5.0-beta3 (November 12, 2015)

* Still more work on submodule authentication support by allowing
submodules to use parent credentials (https://issues.jenkins.io/browse/JENKINS-20941[JENKINS-20941])

== Version 2.5.0-beta2 (November 8, 2015)

* More work on submodule authentication support by allowing submodules
to use parent credentials (https://issues.jenkins.io/browse/JENKINS-20941[JENKINS-20941])

== Version 2.5.0-beta1 (November 4, 2015)

* Submodule authentication support by allowing submodules to use
parent credentials (https://issues.jenkins.io/browse/JENKINS-20941[JENKINS-20941])

== Version 2.4.0 (July 18, 2015)

* Branch spec help text improved (https://issues.jenkins.io/browse/JENKINS-27115[JENKINS-27115])
* Allow additional notifyCommit arguments (https://issues.jenkins.io/browse/JENKINS-27902[JENKINS-27902])
* Parameterized branch name handling improvements (Pull requests 226,
308, 309, https://issues.jenkins.io/browse/JENKINS-27327[JENKINS-27327], https://issues.jenkins.io/browse/JENKINS-27351[JENKINS-27351], https://issues.jenkins.io/browse/JENKINS-27352[JENKINS-27352])
* Display error message in log when fetch fails (regression fix)
(https://issues.jenkins.io/browse/JENKINS-26225[JENKINS-26225], https://issues.jenkins.io/browse/JENKINS-27567[JENKINS-27567], https://issues.jenkins.io/browse/JENKINS-27886[JENKINS-27886], https://issues.jenkins.io/browse/JENKINS-28134[JENKINS-28134])
* Fix IllegalStateException when using notifyCommit URL
(https://issues.jenkins.io/browse/JENKINS-26582[JENKINS-26582])
* Allow branch specification regex which does not include '*'
(https://issues.jenkins.io/browse/JENKINS-26842[JENKINS-26842])
* Detect changes correctly when polling
(https://issues.jenkins.io/browse/JENKINS-27093[JENKINS-27093],
https://issues.jenkins.io/browse/JENKINS-27332[JENKINS-27332],
https://issues.jenkins.io/browse/JENKINS-27769[JENKINS-27769])
* Fix GitHub Webhook handling (https://issues.jenkins.io/browse/JENKINS-27282[JENKINS-27282])
* Fix polling with a parameterized branch name (https://issues.jenkins.io/browse/JENKINS-27349[JENKINS-27349])
* Don't throw exception when changelog entry is missing parent
(https://issues.jenkins.io/browse/JENKINS-28260[JENKINS-28260],
https://issues.jenkins.io/browse/JENKINS-28290[JENKINS-28290],
https://issues.jenkins.io/browse/JENKINS-28291[JENKINS-28291])
* Don't throw exception when saving GitLab browser config
(https://issues.jenkins.io/browse/JENKINS-28792[JENKINS-28792])
* Rebuild happened on each poll, even with no changes (https://issues.jenkins.io/browse/JENKINS-29066[JENKINS-29066])
* Remote class loading issue work-around (https://issues.jenkins.io/browse/JENKINS-21520[JENKINS-21520])
...
forward only (https://issues.jenkins.io/browse/JENKINS-12402[JENKINS-12402])
* Handle regular expression branch name correctly even if it does not
contain asterisk (https://issues.jenkins.io/browse/JENKINS-26842[JENKINS-26842])
...
* Expand environment variables in GitPublisher again (https://issues.jenkins.io/browse/JENKINS-24786[JENKINS-24786])
...
* Use git client plugin 1.15.0
* Escape HTML generated into jelly pages with escape="true"
* Fix multiple builds can be triggered for same commit (https://issues.jenkins.io/browse/JENKINS-25639[JENKINS-25639])
...
(https://issues.jenkins.io/browse/JENKINS-25639[JENKINS-25639])
...
credential (https://issues.jenkins.io/browse/JENKINS-23675[JENKINS-23675])
* Expand parameters on branch spec for remote polling (https://issues.jenkins.io/browse/JENKINS-20427[JENKINS-20427],
https://issues.jenkins.io/browse/JENKINS-14276[JENKINS-14276])
* Fix Gitiles file link for various Gitiles versions (https://issues.jenkins.io/browse/JENKINS-25568[JENKINS-25568])
* Fixed notifyCommit builddata (https://issues.jenkins.io/browse/JENKINS-24133[JENKINS-24133])
...
URL (https://issues.jenkins.io/browse/JENKINS-24133[JENKINS-24133])

== Version 2.2.8 (November 12, 2014)

*  Add submodule update timeout as an option (https://issues.jenkins.io/browse/JENKINS-22400[JENKINS-22400])
*  Update Gitlab support for newer Gitlab versions (https://issues.jenkins.io/browse/JENKINS-25568[JENKINS-25568])
*  No exception if changeset author can't be found (https://issues.jenkins.io/browse/JENKINS-16737[JENKINS-16737] and
https://issues.jenkins.io/browse/JENKINS-10434[JENKINS-10434])
*  Annotate builddata earlier to reduce race conditions (https://issues.jenkins.io/browse/JENKINS-23641[JENKINS-23641])
*  Pass marked revision to decorate revision (https://issues.jenkins.io/browse/JENKINS-25191[JENKINS-25191])
*  Avoid null pointer exception when last repo or branch deleted
(https://issues.jenkins.io/browse/JENKINS-25313[JENKINS-25313])
*  Allow retry by throwing a different exception during certain fetch
failures (https://issues.jenkins.io/browse/JENKINS-20531[JENKINS-20531])
*  Do not require a workspace when polling multiple repositories
(https://issues.jenkins.io/browse/JENKINS-25414[JENKINS-25414])
...
*  Allow retry if fetch fails (https://issues.jenkins.io/browse/JENKINS-20531[JENKINS-20531])
*  Don't NPE if all repos and all branches removed from job definition
(https://issues.jenkins.io/browse/JENKINS-25313[JENKINS-25313])
*  Correctly record built revision even on failed merge (https://issues.jenkins.io/browse/JENKINS-25191[JENKINS-25191])
*  Record build data sooner for better concurrency and safety
(https://issues.jenkins.io/browse/JENKINS-23641[JENKINS-23641])
*  Do not throw exception if author can't be found in change set
(https://issues.jenkins.io/browse/JENKINS-16737[JENKINS-16737], https://issues.jenkins.io/browse/JENKINS-10434[JENKINS-10434])
...
(https://issues.jenkins.io/browse/JENKINS-21464[JENKINS-21464])
*  Fix GitPublisher null pointer exception when previous agent is
missing
*  Expand variables in branch spec for remote polling (https://issues.jenkins.io/browse/JENKINS-20427[JENKINS-20427],
https://issues.jenkins.io/browse/JENKINS-14276[JENKINS-14276])
...
*  Add optional "force" to push from publisher (https://issues.jenkins.io/browse/JENKINS-24082[JENKINS-24082])
*  Support gitlist as a repository browser (https://issues.jenkins.io/browse/JENKINS-19029[JENKINS-19029])
...
"ssh not found" (https://issues.jenkins.io/browse/JENKINS-24516[JENKINS-24516], https://issues.jenkins.io/browse/JENKINS-24467[JENKINS-24467])
*  Pass a listener to calls to getEnvironment (https://issues.jenkins.io/browse/JENKINS-24772[JENKINS-24772])

== Version 2.3-beta-2 (September 3, 2014)

* Print remote head when fetching a SHA1
*  Assembla browser breaks config page (https://issues.jenkins.io/browse/JENKINS-24261[JENKINS-24261])
*  Recent changes is always empty in merge job (https://issues.jenkins.io/browse/JENKINS-20392[JENKINS-20392])
*  Polling incorrectly detects changes when refspec contains variable
(https://issues.jenkins.io/browse/JENKINS-22009[JENKINS-22009])
*  Matrix project fails pre-merge (https://issues.jenkins.io/browse/JENKINS-23179[JENKINS-23179])
...
*  Return correct date/time to REST query of build date (https://issues.jenkins.io/browse/JENKINS-23791[JENKINS-23791])
*  Add timeout option to checkout (for slow file systems and large
repos) (https://issues.jenkins.io/browse/JENKINS-22400[JENKINS-22400])
*  Expand parameters on repository url before evaluating credentials
(https://issues.jenkins.io/browse/JENKINS-23675[JENKINS-23675])
...
(https://issues.jenkins.io/browse/JENKINS-23791[JENKINS-23791])
...
* Adapting to SCM API changes in Jenkins 1.568+. (https://issues.jenkins.io/browse/JENKINS-23365[JENKINS-23365])
...
* Option to set submodules update timeout (https://issues.jenkins.io/browse/JENKINS-22400[JENKINS-22400])

== Version 2.2.2 (June 24, 2014)

* Remote API export problem finally fixed (https://issues.jenkins.io/browse/JENKINS-9843[JENKINS-9843])

== Version 2.2.1 (April 12, 2014)

* Allow clean before checkout (https://issues.jenkins.io/browse/JENKINS-22510[JENKINS-22510])
* Do not append trailing slash to most repository browser URL's
(https://issues.jenkins.io/browse/JENKINS-22342[JENKINS-22342])
* Fix null pointer exception in git polling with inverse build chooser
(https://issues.jenkins.io/browse/JENKINS-22053[JENKINS-22053])

== Version 2.2.0 (April 4, 2014)

* Add optional submodule remote tracking if git version newer than
1.8.2 (https://issues.jenkins.io/browse/JENKINS-19468[JENKINS-19468])
...
(https://issues.jenkins.io/browse/JENKINS-21809[JENKINS-21809])
* Improve performance when many branches are in the repository
(https://issues.jenkins.io/browse/JENKINS-5724[JENKINS-5724])
* Retain git browser URL when saving job configuration
(https://issues.jenkins.io/browse/JENKINS-22064[JENKINS-22064])
* Resolve tags which contain slashes (https://issues.jenkins.io/browse/JENKINS-21952[JENKINS-21952])

== Version 2.0.4 (March 6, 2014)

* Allow extension to require workspace for polling (https://issues.jenkins.io/browse/JENKINS-19001[JENKINS-19001])
* ??? (tbd)
...
* Extend branch specifier (https://issues.jenkins.io/browse/JENKINS-17417[JENKINS-17417]) and git repository URL
* Better support for branches with "/" in name (https://issues.jenkins.io/browse/JENKINS-14026[JENKINS-14026])
* Improve backward compatibility (https://issues.jenkins.io/browse/JENKINS-20861[JENKINS-20861])

== Version 2.0.1 (January 8, 2014)

* Use git-credentials-store so http credentials don't appear in
workspace (https://issues.jenkins.io/browse/JENKINS-20318[JENKINS-20318])
* Prune branch during fetch (https://issues.jenkins.io/browse/JENKINS-20258[JENKINS-20258])
* Fix migration for 1.x skiptag option (https://issues.jenkins.io/browse/JENKINS-20561[JENKINS-20561])
* Enforce Refsepc configuration after clone (https://issues.jenkins.io/browse/JENKINS-20502[JENKINS-20502])
...
(https://issues.jenkins.io/browse/JENKINS-14321[JENKINS-14321])
* Fixed variable expansion during polling (https://issues.jenkins.io/browse/JENKINS-7411[JENKINS-7411])
* Added Phabricator and Kiln Harmony repository browsers, fixed
GitLab URLs

== Version 1.4.0 (May 13, 2013)

* Avoid spaces in tag name, rejected by JGit (https://issues.jenkins.io/browse/JENKINS-17195[JENKINS-17195])
* Force UTF-8 encoding to read changelog file (https://issues.jenkins.io/browse/JENKINS-6203[JENKINS-6203])
* Retry build if SCM retry is configured
(https://issues.jenkins.io/browse/https://issues.jenkins.io/browse/JENKINS-14575[JENKINS-14575])
* Allow merge results to push from agents, not just from the controller
node (https://issues.jenkins.io/browse/https://issues.jenkins.io/browse/JENKINS-16941[JENKINS-16941])

== Version 1.3.0 (March 12, 2013)

* Fix a regression fetching from multiple remote repositories
(https://issues.jenkins.io/browse/JENKINS-16914[JENKINS-16914])
* Fix stackoverflow recursive invocation error caused by
MailAddressResolver (https://issues.jenkins.io/browse/JENKINS-16849[JENKINS-16849])
* Fix invalid id computing merge changelog (https://issues.jenkins.io/browse/JENKINS-16888[JENKINS-16888])
* Fix lock on repository files (https://issues.jenkins.io/browse/JENKINS-12188[JENKINS-12188])
* Use default git installation if none matches (https://issues.jenkins.io/browse/JENKINS-17013[JENKINS-17013]).
* Expand _reference_ parameter when set with variables
* Expose GIT_URL environment variable (https://issues.jenkins.io/browse/JENKINS-16684[JENKINS-16684])
...
* restore BuildChooser API signature, that introduced https://issues.jenkins.io/browse/JENKINS-16851[JENKINS-16851]
...
whitespace. (https://issues.jenkins.io/browse/JENKINS-15235[JENKINS-15235])
* set changeSet.kind to "git"
* Avoid some calls to "git show"
* Fix checking for an email address (https://issues.jenkins.io/browse/JENKINS-16453[JENKINS-16453])
* update Git logo icon
* Pass combineCommits to action (https://issues.jenkins.io/browse/JENKINS-15160[JENKINS-15160])
...
* git polling mechanism can have build in infinite loop (https://issues.jenkins.io/browse/JENKINS-15803[JENKINS-15803])
...
* NullPointerException during tag publishing (https://issues.jenkins.io/browse/JENKINS-15391[JENKINS-15391])
* Adds http://rhodecode.org/[RhodeCode] support (https://issues.jenkins.io/browse/JENKINS-15420[JENKINS-15420])
...
https://issues.jenkins.io/browse/https://issues.jenkins.io/browse/JENKINS-15048[JENKINS-15048][issue #15048]
* Use correct refspec when fetching submodules
https://issues.jenkins.io/browse/https://issues.jenkins.io/browse/JENKINS-8149[JENKINS-8149][issue #8149]
...
https://issues.jenkins.io/browse/JENKINS-14480[JENKINS-14480]
* Add support for variable expansion on branch spec (not just job
parameters) https://issues.jenkins.io/browse/JENKINS-8563[JENKINS-8563]
* Use controller environment, not last build node, for fast remote polling
https://issues.jenkins.io/browse/JENKINS-14321[JENKINS-14321]
* run reset --hard on clean to take care of any local artifact
* normalize maven repository ID https://issues.jenkins.io/browse/JENKINS-14443[JENKINS-14443]

== Version 1.1.21 (July 10, 2012)

* Fixed support for "/" in branches names (https://issues.jenkins.io/browse/JENKINS-14026[JENKINS-14026])
* Fixed issue on windows+msysgit to escape "^" on git command line
(https://issues.jenkins.io/browse/JENKINS-13007[JENKINS-13007])

== Version 1.1.20 (June 25, 2012)

* Fixed NPE (https://issues.jenkins.io/browse/JENKINS-10880[JENKINS-10880])
* Fixed a git-rev-parse problem on Windows (https://issues.jenkins.io/browse/JENKINS-13007[JENKINS-13007])
* Use 'git whatchanged' instead of 'git show' (https://issues.jenkins.io/browse/JENKINS-13580[JENKINS-13580])
* Added git note support

== Version 1.1.19 (June 8, 2012)

* restore GitAPI constructor for backward compatibility (https://issues.jenkins.io/browse/JENKINS-12025[JENKINS-12025])
* CGit browser support (https://issues.jenkins.io/browse/JENKINS-6963[JENKINS-6963]).
* Handle special meaning of some characters on Windows (https://issues.jenkins.io/browse/JENKINS-13007[JENKINS-13007])
* fixed java.lang.NoSuchMethodError: java/lang/String.isEmpty()
(https://issues.jenkins.io/browse/JENKINS-13993[JENKINS-13993]).
* Git icon(git-48x48.png) missing in job page. (https://issues.jenkins.io/browse/JENKINS-13413[JENKINS-13413]).
* Git "Tag to push" should trim whitespace (https://issues.jenkins.io/browse/JENKINS-13550[JENKINS-13550]).
...
* Fixed NPE in `+compareRemoteRevisionWith+` (https://issues.jenkins.io/browse/JENKINS-10880[JENKINS-10880])
...
* option to set includes regions (https://issues.jenkins.io/browse/JENKINS-11749[JENKINS-11749])
* fix regression to deserialize build history (https://issues.jenkins.io/browse/JENKINS-12369[JENKINS-12369])

== Version 1.1.15 (December 27, 2011)

* Fixed a bug where the push notification didn't work with
read-protected projects. (https://issues.jenkins.io/browse/JENKINS-12022[JENKINS-12022])
...
* option to ignore submodules completely (https://issues.jenkins.io/browse/JENKINS-6658[JENKINS-6658])
* support FishEye scm browser (https://issues.jenkins.io/browse/JENKINS-7849[JENKINS-7849])
...
* fix databinding bug (https://issues.jenkins.io/browse/JENKINS-9914[JENKINS-9914])
...
* Git now polls without needing a workspace (https://issues.jenkins.io/browse/JENKINS-10131[JENKINS-10131])
* Fixed the "no remote from branch name" problem (https://issues.jenkins.io/browse/JENKINS-10060[JENKINS-10060])
...
* Fixed DefaultBuildChooser logic (https://issues.jenkins.io/browse/JENKINS-10408[JENKINS-10408])

== Version 1.1.10 (July 15, 2011)

* Merge options persist properly now. (https://issues.jenkins.io/browse/JENKINS-10270[JENKINS-10270])
* Fixed NPE in PreBuildMergeOptions when using REST API. (https://issues.jenkins.io/browse/JENKINS-9843[JENKINS-9843])
* Global config name/email handle whitespace properly. (https://issues.jenkins.io/browse/JENKINS-10272[JENKINS-10272],
https://issues.jenkins.io/browse/JENKINS-9566[JENKINS-9566])
* Improved memory handling of "git whatchanged". (https://issues.jenkins.io/browse/JENKINS-8365[JENKINS-8365])
* Excluded regions should now work with multiple commit changesets.
(https://issues.jenkins.io/browse/JENKINS-8342[JENKINS-8342])
* ViewGit support added. (https://issues.jenkins.io/browse/JENKINS-5163[JENKINS-5163])
* Fixed NPE when validating remote for publisher. (https://issues.jenkins.io/browse/JENKINS-9971[JENKINS-9971])
* Tool selection persists now. (https://issues.jenkins.io/browse/JENKINS-9765[JENKINS-9765])
* Remote branch pruning now happens after fetch, to make sure all
remotes are defined. (https://issues.jenkins.io/browse/JENKINS-10348[JENKINS-10348])

== Version 1.1.9 (May 16, 2011)

* Don't strip off interesting stuff from branch names in token macro
(https://issues.jenkins.io/browse/JENKINS-9510[JENKINS-9510])
...
"git remote prune" against it. (https://issues.jenkins.io/browse/JENKINS-9661[JENKINS-9661])
* Eliminate a problem with NPEs on git config user.name/user.email usage
on upgrades. (https://issues.jenkins.io/browse/JENKINS-9702[JENKINS-9702])
* Add a check for git executable version as 1.7 or greater before using
--progress on git clone calls. (https://issues.jenkins.io/browse/JENKINS-9635[JENKINS-9635])
...
(https://issues.jenkins.io/browse/JENKINS-9253[JENKINS-9253])
* Improved wording of error message when no revision is found to build.
(https://issues.jenkins.io/browse/JENKINS-9339[JENKINS-9339])
* Added "--progress" to git clone call. (https://issues.jenkins.io/browse/JENKINS-9168[JENKINS-9168])
* Underlying error actually shown when git fetch fails. (https://issues.jenkins.io/browse/JENKINS-9052[JENKINS-9052])
* git config options for user.name and user.email now save properly.
(https://issues.jenkins.io/browse/JENKINS-9071[JENKINS-9071])
* Properly handle empty string for branch when branch is parameterized.
(https://issues.jenkins.io/browse/JENKINS-8656[JENKINS-8656])
...
that instead. (https://issues.jenkins.io/browse/JENKINS-9016[JENKINS-9016])
...
build's SHA1 no longer exists in repository. (https://issues.jenkins.io/browse/JENKINS-8853[JENKINS-8853])
* Fixed bug causing "Firstname \Lastname@domain.com" to be used as email
address for users. (https://issues.jenkins.io/browse/JENKINS-7156[JENKINS-7156])
* Passwords should now be properly used in https URLs. (https://issues.jenkins.io/browse/JENKINS-3807[JENKINS-3807])
...
commit.)
* Allowed optional disabling of internal tagging (https://issues.jenkins.io/browse/JENKINS-5676[JENKINS-5676])
* If specified, use configured values for user.email and user.name
(https://issues.jenkins.io/browse/JENKINS-2754[JENKINS-2754])
...
the configuration build (https://issues.jenkins.io/browse/JENKINS-5005[JENKINS-5005]).
* Switching between browsers does not function properly (https://issues.jenkins.io/browse/JENKINS-8210[JENKINS-8210]).
...
* Fixed major bug in polling (https://issues.jenkins.io/browse/JENKINS-8032[JENKINS-8032])

== Version 1.1.1 (November 5, 2010)

* Improved logging for failures with git fetch.
* Made sure .gitmodules is closed properly. (https://issues.jenkins.io/browse/JENKINS-7659[JENKINS-7659])
* Fixed issue with polling failing if the conitroller has 0 executors.
(https://issues.jenkins.io/browse/JENKINS-7547[JENKINS-7547])
* Modified Git publisher to run as late as possible in the post-build
plugin order. (https://issues.jenkins.io/browse/JENKINS-7877[JENKINS-7877])
* Added optional call to "git remote prune" to prune obsolete local
branches before build. (https://issues.jenkins.io/browse/JENKINS-7831[JENKINS-7831])

== Version 1.1 (September 21, 2010)

* Added ability for GitPublisher to only push if build succeeds.
(https://issues.jenkins.io/browse/JENKINS-7176[JENKINS-7176])
* Fixed major bug with submodule behavior - making sure we don't try to
fetch submodules until we've finished the initial clone. (https://issues.jenkins.io/browse/JENKINS-7258[JENKINS-7258])
* "Clean after checkout" wasn't invoked when pre-build merges were
enabled. (https://issues.jenkins.io/browse/JENKINS-7276[JENKINS-7276])
...
leading to confusion. (https://issues.jenkins.io/browse/JENKINS-7277[JENKINS-7277])
* "Clean before build" will now run in submodules as well as root.
(https://issues.jenkins.io/browse/JENKINS-7376[JENKINS-7376])
* When polling, Hudson-configured environment variables were not being
used. (https://issues.jenkins.io/browse/JENKINS-7411[JENKINS-7411])
* Modifications to BuildData to deal with Hudson no longer serializing
null keys. (https://issues.jenkins.io/browse/JENKINS-7446[JENKINS-7446])
* Support for --recursive option to submodule commands. (https://issues.jenkins.io/browse/JENKINS-6258[JENKINS-6258])

== Version 1.0.1 (August 9, 2010)

* Fixed submodules support - was broken by https://issues.jenkins.io/browse/JENKINS-6902[JENKINS-6902] fix.
(https://issues.jenkins.io/browse/JENKINS-7141[JENKINS-7141])
* Switched "Recent Changes" list for a project to count changes per
build, rather than using revision as if it were a number. (https://issues.jenkins.io/browse/JENKINS-7154[JENKINS-7154])
* Stopped putting problematic slash at end of GitWeb URL. (https://issues.jenkins.io/browse/JENKINS-7020[JENKINS-7020])
...
workspace (https://issues.jenkins.io/browse/JENKINS-6357[JENKINS-6357])
* If all repository fetches fail, fail the build. (https://issues.jenkins.io/browse/JENKINS-6902[JENKINS-6902])
* Improved logging of git command execution errors (https://issues.jenkins.io/browse/JENKINS-6330[JENKINS-6330])
* Basic support for excluded regions and excluded users in polling added
(https://issues.jenkins.io/browse/JENKINS-4556[JENKINS-4556])
* Support for optionally checking out to a local branch, rather than
detached HEAD (https://issues.jenkins.io/browse/JENKINS-6856[JENKINS-6856])
...
(https://issues.jenkins.io/browse/JENKINS-5371[JENKINS-5371])

== Version 0.9.2 (June 22, 2010)

* Fixed major bug in BuildChooser default selection and serialization
(https://issues.jenkins.io/browse/JENKINS-6827[JENKINS-6827])

== Version 0.9.1 (June 22, 2010)

* Dramatic improvement in changelog generation, thanks to a switch to
use "git whatchanged" (https://issues.jenkins.io/browse/JENKINS-6781[JENKINS-6781])
...
* Fixed https://issues.jenkins.io/browse/JENKINS-2931[JENKINS-2931], git tag freezing job execution (jbq)
* Improve log messages (jbq)
* Use build listener to report messages when pushing tags to origin
(jbq)
* Fixed https://issues.jenkins.io/browse/JENKINS-2762[JENKINS-2762], fail to clone a repository on Windows (jbq)
...
to find last build, see https://issues.jenkins.io/browse/JENKINS-2469[JENKINS-2469]: GIT plugin very slow (jbq)
...
tag reference (jbq)
* Fix https://issues.jenkins.io/browse/JENKINS-2675[JENKINS-2675], Git fails on remote agents (jbq)
